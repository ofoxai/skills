...
| [explainer](skills/explainer/SKILL.md) | An article, doc or release note as a short spoken clip. A 30-second clip holds about eighty words in eight sentences — measured, and well under a tenth of a 1,200-word post — so it doesn't summarise the piece. Sentence count costs as much as word count, because each boundary is about 0.7s of silence. It picks the one idea worth saying, and helps you choose which. |
